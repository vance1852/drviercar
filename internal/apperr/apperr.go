...
// IsPermanent reports whether err describes a refusal that a retry with the same
// input cannot turn into a success.
func IsPermanent(err error) bool {
	switch KindOf(err) {
	case KindInvalid, KindForbidden, KindNotFound, KindPrecondition:
		return true
	default:
		return false
	}
